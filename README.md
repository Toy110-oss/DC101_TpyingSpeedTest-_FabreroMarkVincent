...
4. Open `index.html` using any modern web browser (Chrome, Edge, Firefox, etc.).
5. Start typing the displayed text to begin the test and view your results once the time ends.
